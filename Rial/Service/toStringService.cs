...
namespace Rial.Service
{
    internal class toStringService
    {
        ...
        public string num2rial(string snum)
        {
            string stotal = "";
            if (snum == "") return "صفر";
            if (snum == "0")
            ...
            else
            {
                ...
                snum = snum.PadLeft(((snum.Length) / 3 + 1) * 3, '0');
                ...
                stotal = stotal.Substring(0, stotal.Length - 3) + "ریال";
            }
            return stotal;
           
        }
        public string num2Toman(string snum)
        {
            int x = snum.Length;
            snum = snum.Substring(0, x - 1);
            ...
            else
            {
                ...
                stotal = stotal.Substring(0, stotal.Length - 3) + "تومان";
            }
            return stotal;
